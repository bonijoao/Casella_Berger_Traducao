# Inferência Estatística — Tradução para o Português

Este repositório contém a tradução para o português brasileiro do clássico **Statistical Inference** (2ª edição), de George Casella e Roger L. Berger.
...
Este projeto utiliza [Quarto](https://quarto.org/) para gerar o livro em formato HTML. Para renderizar localmente:

```bash
# Clone o repositório
git clone https://github.com/bonijoao/Casella_Berger_Traducao.git

# Entre na pasta
cd Casella_Berger_Traducao

# Renderize o livro
quarto render

# Ou visualize em tempo real
quarto preview
```
